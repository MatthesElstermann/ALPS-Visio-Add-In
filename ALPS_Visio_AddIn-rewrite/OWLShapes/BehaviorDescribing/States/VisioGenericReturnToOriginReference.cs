...
namespace ALPS_Visio_AddIn_rewrite.OWLShapes
{
    ...
    {
        private const string type = ALPSConstants.alpsSBDMasterGenericReturnToOriginReference;
        private readonly IShapeExport export;

        public VisioGenericReturnToOriginReference(ISubjectBehavior behavior) : base(behavior)
        {
