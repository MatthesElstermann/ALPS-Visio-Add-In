...
namespace VisioAddIn
{
    ...
    public partial class WindowChangeLayerName : Window
    {
        ...
        public WindowChangeLayerName(IDialogCallback callback, ModelController modelController, SIDPage changed)
        {
            ...
            labelRename.Content = ALPS_Visio_AddIn_rewrite.Resources.strings.ChangeLayerNameRename;
            Title = ALPS_Visio_AddIn_rewrite.Resources.strings.ChangeLayerNameTitle;
